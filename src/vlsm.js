...
envoyer.addEventListener("click", () => {
    ...
    if (
        ...
        function showTableView() {
            ...
            const hasInsufficientAddresses = resultsArray.some(result => result.pasDeReseau);
            ...
            if (hasInsufficientAddresses) {
                ...
                warningMessage.innerHTML = "<strong>Attention :</strong> Certains sous-réseaux n'ont pas pu être créés car il n'y a pas assez d'adresses disponibles avec le CIDR spécifié.";
            ...
            resultsArray.forEach((result) => {
                ...
                if (result.pasDeReseau) {
                    ...
                    errorCell.colSpan = 7;
                    errorCell.textContent = "Pas assez d'adresses disponibles pour ce sous-réseau";
            ...
            if (!hasValidNetworks) {
                ...
                noValidNetworksMessage.style.boxShadow = "0 0 10px rgba(255, 46, 99, 0.5)";
                noValidNetworksMessage.style.textShadow = "0 0 5px rgba(255, 46, 99, 0.7)";
                noValidNetworksMessage.innerHTML = "<strong>Erreur :</strong> Aucun sous-réseau n'a pu être créé avec le CIDR spécifié. Veuillez utiliser un CIDR plus petit (ex: /16 au lieu de /24) ou réduire le nombre d'hôtes demandés.";
